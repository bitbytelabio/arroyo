...
impl ValuePointerContext {
    ...
    pub(crate) fn compile_filter_expression<CG: CodeGenerator<Self, TypeDef, syn::Expr>>(
        ...
        let TypeDef::DataType(DataType::Boolean, nullable) = code_generator.expression_type(self) else {
    ...
    >(
        ...
        let TypeDef::DataType(DataType::Timestamp(_, _), nullable) = code_generator.expression_type(self) else {
